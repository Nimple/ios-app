...
- (NimpleContact *)saveNimpleContactWith:(NSArray *)contactData andContactHash:(NSString *)contactHash {
    ...
    [scannedContact setValueForPrename:contactData[1] Surname:contactData[0] PhoneNumber:contactData[2] MailAddress:contactData[3] JobTitle:contactData[4] Company:contactData[5] FacebookURL:contactData[6] FacebookID:contactData[7] TwitterURL:contactData[8] TwitterID:contactData[9] XingURL:contactData[10] LinkedInURL:contactData[11] Created:[NSDate date] ContactHash:contactHash Note: @"" withStreet:contactData[12] andPostal:contactData[13] andCity:contactData[14] andWebsite:contactData[15]];
