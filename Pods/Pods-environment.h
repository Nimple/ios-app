...
// XNGAPIClient
#define COCOAPODS_POD_AVAILABLE_XNGAPIClient
#define COCOAPODS_VERSION_MAJOR_XNGAPIClient 0
#define COCOAPODS_VERSION_MINOR_XNGAPIClient 1
#define COCOAPODS_VERSION_PATCH_XNGAPIClient 0

// XNGOAuth1Client
#define COCOAPODS_POD_AVAILABLE_XNGOAuth1Client
#define COCOAPODS_VERSION_MAJOR_XNGOAuth1Client 0
#define COCOAPODS_VERSION_MINOR_XNGOAuth1Client 0
#define COCOAPODS_VERSION_PATCH_XNGOAuth1Client 2
